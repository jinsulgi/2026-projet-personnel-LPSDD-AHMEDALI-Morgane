# 2026-projet-personnel-LPSDD-AHMEDALI-Morgane

Étude de l'anglicisation des paroles K-pop (2000–2022) à partir du corpus Genius.

## Notebooks
- `data_prep_kpop_lyrics.ipynb` — Préparation et filtrage du dataset Kaggle
...
Le notebook `data_prep_kpop_lyrics.ipynb` peut prendre 20–40 minutes à s'exécuter selon les performances de la machine.
Il est possible de partir directement du fichier prétraité via le lien ci-dessus.
